...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_preonic_1x2uC(
    ...
    TD(TD_MENU),       TD(TD_FN), KC_LALT, LGUI_T(KC_F16), MO(1),      KC_SPC,     MO(2), TD(TD_PGDWN), TD(TD_PGUP), TD(TD_BCK),  TD(TD_FWD)
  ),
  ...
  [1] = LAYOUT_preonic_1x2uC(
    ...
    KC_NO,        KC_NO,    KC_TRNS,    KC_TRNS,       KC_NO,          KC_SPC,    MO(4),       KC_VOLD,    KC_VOLU,         KC_MPRV,       KC_MNXT
  ),
  
  [2] = LAYOUT_preonic_1x2uC(
    KC_GRV,         SGUI(KC_F),  SGUI(KC_4), KC_NO,          KC_NO,      KC_NO,        KC_NO,   KC_NO,         KC_NO,   KC_LBRC,       KC_RBRC, KC_EQL, 
    KC_NO,          KC_NO,       KC_NO,      LALT(KC_BSPC),  KC_NO,      KC_NO,        KC_NO,   LALT(KC_LEFT), KC_UP,   LALT(KC_RGHT), KC_NO,   KC_NO, 
    LCTL_T(KC_ENT), KC_NO,       KC_NO,      KC_BSPC,        KC_DEL,     LALT(KC_DEL), KC_NO,   KC_LEFT,       KC_DOWN, KC_RGHT,       KC_ENT,  KC_NO, 
    KC_LSFT, LGUI(KC_Z),  LGUI(KC_X),   LGUI(KC_C),     LGUI(KC_V), KC_NO,        KC_NO,   KC_NO,         KC_F7,   KC_F9,         KC_MPLY,   KC_MUTE, 
    KC_NO,        KC_NO,     KC_TRNS,    KC_TRNS,        MO(4),             KC_SPC,         KC_NO,       KC_VOLD, KC_VOLU,    KC_MPRV, KC_MNXT
  ),
  ...
  [3] = LAYOUT_preonic_1x2uC(
    ...
    KC_NO, TD(TD_FN), KC_DOT,   KC_P0,   MO(1),       KC_SPC,        KC_NO, KC_DOWN, KC_UP,   KC_LEFT,   KC_RGHT
  ),
  ...
  [5] = LAYOUT_preonic_1x2uC(
    ...
    KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,       KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, 
    KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,       KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, 
    KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_TRNS,       KC_SPC,        KC_TRNS,   KC_SLCK, KC_PAUSE, KC_NO,   KC_NO
  )
